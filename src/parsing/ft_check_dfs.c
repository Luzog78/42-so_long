...
t_bool	ft_check_dfs(t_data *data, t_vec2 curr, t_vec2 to, t_list_vec2 **list)
{
	...
	return (ft_check_dfs(data, (t_vec2){curr.x + 1, curr.y}, to, list)
		|| ft_check_dfs(data, (t_vec2){curr.x - 1, curr.y}, to, list)
		|| ft_check_dfs(data, (t_vec2){curr.x, curr.y + 1}, to, list)
		|| ft_check_dfs(data, (t_vec2){curr.x, curr.y - 1}, to, list));
}
